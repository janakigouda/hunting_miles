...
$q = "SELECT * FROM vehicle v,customer c WHERE c.c_id=v.cust_id AND v.v_status='booked'";
          ...
          <td class="dropdown" id="ve">
            ...
            <span class="mr-2 d-none d-lg-inline text-gray small btn btn-info" id="veh">
              ...
              <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="vDropdown">
                <a class="dropdown-item" name="update" href="update_v.php?ans=<?php echo $row['v_id']; ?>">
                  Update
                </a>
                <a class="dropdown-item" href="view_b.php?ans=<?php echo $row['v_id'];?>">
                  View
                </a>
              </div>
          </td>
