...
$q = "SELECT * FROM services s,customer c WHERE c.c_id=s.cust_id";
    ...
    ?>
      <tbody id="myTable">
        <tr>
          ...
          <td><a class="mr-2 d-none d-lg-inline text-gray small btn btn-info" id="veh" href="view_service.php?ans=<?php echo $row['s_id'];?>">
                  View
                </a>
