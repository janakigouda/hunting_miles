...
<div class="container" id="container">
  <form class="form-inline" action="warrenty1.php" method="POST">
  ...
  <div class="form-group col-6" id="group">
    ...
    <div class="form-group col-6" id="group">
        <label for="wdate">Warrenty period:</label>
        <input type="text" class="form-control col-9" placeholder="Enter warrenty period" id="wdate" name="wdate">
    </div><br>
